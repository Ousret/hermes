...
class AdminLte(Admin):
    ...
    def __init__(self, app = None, name = None, url = None, subdomain = None, index_view = None,
        ...
        self.add_view(AdminsView(User, admin_db.session, name = "Utilisateurs", menu_icon_value = 'fa-user-secret'))

    def gravatar_image_url(self, email, default_url, size = 96):
        return "https://www.gravatar.com/avatar/"+sha256(email.encode('utf-8')).hexdigest()
