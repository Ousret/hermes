...
class ActionNoeudLegacySchema(ma.SQLAlchemySchema):
    class Meta:
        model = ActionNoeud
...
class RechercheInteretLegacySchema(ma.SQLAlchemySchema):
    class Meta:
...
class DetecteurLegacySchema(ma.SQLAlchemySchema):
...
class AutomateLegacySchema(ma.SQLAlchemySchema):
    class Meta:
        model = Automate
